...
// Exercise 1 - Practice with WritingAssignment to utilize Base Class and Inheritance
// Author: Tom Gibb
// Date: 06-02-2026
...
{    private string _title;
    ...
    public static string GetTextBookSection()
    {
        Console.WriteLine("This is the textbook section for the writing assignment.");
        // Define the textbook section for the writing assignment here.

        string textbookSection = "3.8 - Writing Assignments";
    ...
    {
        // This method will be used to set the textbook section for the writing assignment.
        Console.WriteLine("This is the textbook section for the writing assignment.");
        Console.WriteLine(textbookSection);
    }
}
